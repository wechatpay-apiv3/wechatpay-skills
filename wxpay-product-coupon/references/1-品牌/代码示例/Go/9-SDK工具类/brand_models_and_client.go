...
//
// 本文件包含品牌直连模式下所有接口通用的：
// 1. HTTP 客户端（签名、发送请求、验签）— 以创建商品券为例
// 2. 所有请求/响应数据模型结构体定义
// 3. 所有枚举类型定义
//
...
// CreateProductCoupon 创建商品券
// 接口地址：POST https://api.mch.weixin.qq.com/brand/marketing/product-coupon/product-coupons
...
type StockStoreScope_Deprecated = StockStoreScope // alias kept for backward compat
